    ...
    for (const key in localStorage) {
      if (key.startsWith("Producto")) {
        ...
        if (partes.length==3){
          ...
          if (key=='Producto7') {
            l_descripcion='Cremas';
            l_img='https://i.pinimg.com/564x/0e/ce/95/0ece95f2f8427dd6a197c2cfd3bd6783.jpg';

          }
          if (key=='Producto8') {
            l_descripcion='Kit de maquillaje';
            l_img='https://i.pinimg.com/564x/a2/e0/6d/a2e06d22d81ffc75da527489a486b21f.jpg';

          }
          if (key=='Producto9') {
            l_descripcion='Esmalte para uñas';
            l_img='https://i.pinimg.com/564x/1c/97/8c/1c978cdef542ae3f05fe20af88add5b0.jpg';
